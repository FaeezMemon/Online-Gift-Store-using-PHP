            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="categories.php">Choose Categories</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="gifts.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite Giftss</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order and Pay</a></li>
                        
                    </ul>
                </div>
            </div>
			<?php $ress= mysqli_query($db,"select * from subcategory where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/view_menu.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="admin/Res_img/'.$rows['image'].'" alt="sub-category img">'; ?></figure>
                                </div>
                            </div>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="gifts.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-md-8">
						...
						<?php  
									$stmt = $db->prepare("select * from all_gifts where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='gifts.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
										...
										<span class="price pull-left" >Rs <?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="text" name="quantity"  style="margin-left:30px;border:none;" value="1" size="2" />
